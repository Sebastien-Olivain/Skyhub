...
class SessionsDeactivateCommand extends Command
{
    protected static $defaultName = 'app:session:deactivate';
    protected static $defaultDescription = 'Deactivates outdated sessions';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $nbDeactivatedSessions = $this->sessionRepository->deactivateOutdated($limit);

        $io->success($nbDeactivatedSessions . ' session(s) ont été désactivées.');
